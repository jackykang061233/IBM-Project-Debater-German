...
class Pattern:
    ...
    def __init__(self):
        ...
        # r'((\w+\-*\s*){1,10})\b(e\.g\. ']
        self.consistent_pattern = [r' is a)\s+(.+?)\.',
                                   r' is an)\s+(.+?)\.',
                                   r' is a kind of)\s+(.+?)\.',
                                   r' is a form of)\s+(.+?)\.',
                                   r' is an example of)\s+(.+?)\.',
                                   r' is a special case of)\s+(.+?)\.',
                                   r' or other)\s+(.+?)\.',
                                   r' or other types of)\s+(.+?)\.',
                                   r' or other kinds of)\s+(.+?)\.',
                                   r' or another type of)\s+(.+?)\.',
                                   r' and other)\s+(.+?)\.',
                                   r' and other types of)\s+(.+?)\.',
                                   r' and other kinds of)\s+(.+?)\.']
            ...
            for outlink in outlinks:
                try:
                    ...
                    for pattern in self.consistent_pattern:
                        ...
                        if match:
                            for m in match:
                                topic[concept].append(m[0] + ' ' + m[1] + '.')  # add the sentence matched with the pattern
