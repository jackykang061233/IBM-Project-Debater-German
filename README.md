...
1. embedding: Which word embedding is being used, fasttext, spacy, or statified. The fasttext embedding can be found at https://fasttext.cc/docs/en/crawl-vectors.html
